			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="date" title="${message(code: 'content.date.label', default: 'Date')}" />
					
						<th><g:message code="content.pessoa.label" default="Pessoa" /></th>
				...
				<g:each in="${contentInstanceList}" status="i" var="contentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${contentInstance.date}" /></td>
					
						<td>${fieldValue(bean: contentInstance, field: "pessoa")}</td>
