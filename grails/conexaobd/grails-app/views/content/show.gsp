	...
	<body>
		...
		<div id="show-content" class="content scaffold-show" role="main">
			...
			<ol class="property-list content">
				...
				<g:if test="${contentInstance?.date}">
				<li class="fieldcontain">
					<span id="date-label" class="property-label"><g:message code="content.date.label" default="Date" /></span>
					
						<span class="property-value" aria-labelledby="date-label"><g:formatDate date="${contentInstance?.date}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${contentInstance?.pessoa}">
				<li class="fieldcontain">
					<span id="pessoa-label" class="property-label"><g:message code="content.pessoa.label" default="Pessoa" /></span>
					
						<span class="property-value" aria-labelledby="pessoa-label"><g:link controller="person" action="show" id="${contentInstance?.pessoa?.id}">${contentInstance?.pessoa?.encodeAsHTML()}</g:link></span>
