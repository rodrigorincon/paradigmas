			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="person.conteudo.label" default="Conteudo" /></th>
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${personInstance.id}">${fieldValue(bean: personInstance, field: "conteudo")}</g:link></td>
