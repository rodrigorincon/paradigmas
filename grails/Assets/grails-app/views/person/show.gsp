	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.cars}">
				<li class="fieldcontain">
					<span id="cars-label" class="property-label"><g:message code="person.cars.label" default="Cars" /></span>
				...
				<li class="fieldcontain">
					<span id="hobbies-label" class="property-label"><g:message code="person.hobbies.label" default="Hobbies" /></span>
						...
						<span class="property-value" aria-labelledby="hobbies-label"><g:link controller="hobbie" action="show" id="${h.id}">${h?.encodeAsHTML()}</g:link></span>
						</g:each>
