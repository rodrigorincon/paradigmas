		...
		<div id="show-dog" class="content scaffold-show" role="main">
			...
			<ol class="property-list dog">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="dog.name.label" default="Name" /></span>
						...
						<g:textField name="test" value="${dogInstance?.bark()}" />
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${dogInstance?.id}" />
					<g:link class="edit" action="edit" id="${dogInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
